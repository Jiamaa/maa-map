...
export default function Button(){
    return(
        <div className="flex h-120 justify-center items-center">
            <button className="px-4 py- font-bold text-gray-800 bg-[#739EC9] rounded-full hover:bg-[#5682B1] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-75 rounded-full mt-4 h-15 w-15 cursor-pointer">
